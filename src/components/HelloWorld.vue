<template>
    <div>
        ...
        <div class="btn_box" align="center">
            <button class="btn_cut" @click="cut()">截图</button>
            <button v-if="draw" class="btn_cut_cancel" @click="cancelCut()">取消</button>
        </div>
    </div>
</template>
...
export default {
  ...
  data () {
    return {
        // 储存截图区域的图片,自己传
        imgSrc: 'https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=1906469856,4113625838&fm=26&gp=0.jpg',
        // 储存截图后的生成的base64图片
        cutImgSrc: '',
        // 判断当前是否处于截图状态
        draw: false
